  ...
  return (
    ...
    >
      ...
      <p>
        ...
        one: <strong>determinized Monte Carlo Tree Search</strong>, which samples several complete, plausible
        opponent teams consistent with what's been revealed in battle, runs MCTS against each, and pools the
