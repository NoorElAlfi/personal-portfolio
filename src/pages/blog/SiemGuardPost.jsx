...
function SiemGuardPost() {
  return (
    ...
    >
      ...
      <h2>See it live</h2>
      <p>
        The project ships its own dashboard over the validation results, accuracy by log type,
        the parsing-time bottleneck breakdown, false-positive analysis, and MITRE coverage gaps
        (caveat included, in the UI itself, not just this post):{' '}
        <a href="/siem-guard/dashboard/dashboard.html" target="_blank" rel="noopener noreferrer">open the SIEM Guard dashboard &rarr;</a>
      </p>
