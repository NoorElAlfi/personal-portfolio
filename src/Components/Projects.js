  ...
  return (
    <div>
      ...
      <Space direction="horizontal">
        <Card title="Question Generation Algorithm" style={{ height: 350 }}>
          <p>
        ...
        <Card title="Personal Portofolio" style={{ height: 350 }}>
          <p>
        ...
        <Card title="2X2 Rubiks Cube Solver" style={{ height: 350 }}>
          <p>
